"""
Captura de camara usuario entrada peatonal (Camera250)
...
def capture_camera250(output_dir: str = 'snapshots_camaras') -> dict:
    """Captura foto de la camara de usuario entrada peatonal y retorna solo captura."""
    ip = CAMERA_IP
    user = CAMERA_USER
    ...
    output_file = os.path.join(output_dir, f'camara_usuario_entrada_peatonal_{timestamp}.jpg')
        ...
        for transport in CAPTURE_TRANSPORT_ORDER:
            ...
            if is_valid_capture:
                ...
                return {
                    ...
                    'file': output_file,
                    'size': file_size,
                    'camera': 'Camera250 (Usuario Peatonal)',
                    'ip': ip,
                    'timings': {
