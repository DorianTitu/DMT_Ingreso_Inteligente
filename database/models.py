...
class Captura(Base):
    ...
    ruta_imagen_cedula = Column(String(255), nullable=False)
    ruta_imagen_usuario = Column(String(255), nullable=False)
    ruta_imagen_placa = Column(String(255), nullable=False)
